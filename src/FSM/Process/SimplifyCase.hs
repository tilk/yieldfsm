...
mkLet :: KindMap -> VarKind -> TH.Name -> TH.Exp -> Stmt -> Stmt
mkLet m t n e s
...
simplifyCaseStmt :: KindMap -> Stmt -> Stmt
...
simplifyCaseFunMap :: KindMap -> FunMap -> FunMap
